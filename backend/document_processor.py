...
class DocumentProcessor:
    ...
    def _extract_structured_data(self, text: str, doc_type: str) -> Dict[str, Any]:
        ...
        if doc_type not in self.tax_patterns:
            return extracted
        
        patterns = self.tax_patterns[doc_type]
        ...
        for field, pattern_list in patterns.items():
            for pattern in pattern_list:
                ...
                if matches:
                    ...
                    if field in ['wages', 'income', 'federal_tax', 'tax_withheld']:
                        ...
                        # Clean text values
                        extracted[field] = re.sub(r'[^\w\s&,.-]', '', value).strip()
